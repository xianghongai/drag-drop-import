...
/*
  ...
  */
export const cssImage: ImportStyle[] = [{ value: 0, description: "url('_path_')" }];
...
/*
  ...
  */
export const cssExtensionLanguageImage: ImportStyle[] = [{ value: 0, description: "url('_path_')" }];

/*
  HTML image Import styles
  */
export const HTMLImage: ImportStyle[] = [{ value: 0, description: '<img src="_path_" alt="sample">' }];
...
/*
  Vue Import styles
  */
export const vue: ImportStyle[] = [{ value: 0, description: "import $1 from '_path_';" }];

/*
  Markdown Import styles
  */
export const markdown: ImportStyle[] = [{ value: 0, description: '[text](_path_)' }];

/*
  Markdown (image) Import styles
  */
export const markdownImage: ImportStyle[] = [{ value: 0, description: '![alt-text](_path_ "Hover text")' }];
